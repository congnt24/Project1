...
CREATE TABLE `hoadonxuat` (
  ...
  KEY `id` (`id`),
  CONSTRAINT `hoadonxuat_ibfk_1` FOREIGN KEY (`mahanghoa`) REFERENCES `hang_hoa` (`mahanghoa`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `hoadonxuat_ibfk_2` FOREIGN KEY (`id`) REFERENCES `khachhang` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
