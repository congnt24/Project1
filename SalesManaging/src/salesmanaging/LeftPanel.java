...
public class LeftPanel extends JPanel {
	...
	public LeftPanel() {
		...
		btnXutHngHa = new JButton("Xu\u1EA5t H\u00E0ng H\u00F3a ");
		GridBagConstraints gbc_btnXutHngHa = new GridBagConstraints();
		gbc_btnXutHngHa.fill = GridBagConstraints.HORIZONTAL;
		gbc_btnXutHngHa.insets = new Insets(0, 0, 5, 0);
		gbc_btnXutHngHa.gridx = 1;
		gbc_btnXutHngHa.gridy = 3;
		add(btnXutHngHa, gbc_btnXutHngHa);
